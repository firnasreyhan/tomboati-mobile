...
import com.android.tomboati.view.activity.pendaftaran.PendaftaranDokumenDataDiriActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        materialButtonLanjutkan.setOnClickListener(v -> {
            if(!checkData()) {
                ...
                akunModel.setUserId(editTextRegistrasiUsername.getText().toString().toUpperCase());
