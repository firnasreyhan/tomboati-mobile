...
import com.tomboati.tour.databinding.ActivitySholatSunnahBinding;
...
public class SholatSunnahActivity extends BaseToolbarActivity {

    private ActivitySholatSunnahBinding bind;
    private List<DoaModel> models;

    @Override
    protected void onViewReady(Bundle savedInstanceState, Intent intent) {
        super.onViewReady(savedInstanceState, intent);
        bind = ActivitySholatSunnahBinding.inflate(getLayoutInflater());
        setToolbar(bind.toolbar, "Niat Sholat Sunnah");

        models = new ArrayList<>();

        bind.recyclerViewSholatSunnah.setHasFixedSize(true);
        bind.recyclerViewSholatSunnah.setLayoutManager(new LinearLayoutManager(this));
        ...
        addItem("Niat Sholat Witir", "(Rakaat 3)\nاُصَلِّى سُنًّةَ الْوِتْرِ ثَلاَثَ رَكَعَاتٍ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً مَأْمُوْمًا ِللهِ تَعَالَى\n(Rakaat 2)\nاُصَلِّى سُنًّةَ الْوِتْرِرَكْعَتَيْنِ مُسْتَقْبِلَ الْقِبْلَةِ اَدَاءً مَأْمُوْمًاِللهِ تَعَالَى\n(Rakaat 1)\nاُصَلِّى سُنَّةَ الوِتْرِ رَكْعَةً مُسْتَقْبِلَ الْقِبْلَةِ أَدَاءً مَأْمُوْمًا لِلهِ تَعَالَى", "Ushallii sunnatal witri tsalaasa roka’aatin mustaqbilal qiblati adaa’an (ma’muman/imaman) lillaahi ta’alaa (Rakaat 3), Ushallii sunnatal witri rok ‘atan mustaqbilal qiblati adaa’an (ma’muman / imaman) lillaahi ta’alaa (Rakaat 2),Ushalli sunnatal Witri rak‘atan mustaqbilal qiblati adā’an imāman lillāhi ta‘ālā (Rakaat 1).", "Aku berniat shalat witir tiga rakaat menghadap kiblat menjadi (ma’muman/imaman) karena Allah ta’alaa (Rakaat 3), Saya niat sholat witir satu rakaat menghadap qiblat menjadi makmum karena Allah ta’alaa (Rakaat 2), Aku menyengaja sembahyang sunnah Witir satu rakaat dengan menghadap kiblat, tunai sebagai imam karena Allah SWT (Rakaat 1).", "");
        ...
        bind.recyclerViewSholatSunnah.setAdapter(new DoaHajiUmrahAdapter(models));
    }
